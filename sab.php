...
<link rel="stylesheet" href="../Online Blood Pool/css/style.css" type="text/css" charset="utf-8" />
</head>
<body>
<div id="page">
  <div id="header">
  ...
  <!-- /#header -->
  <div id="body">
  <form action="sab2.php" method="post">
<?php
session_start();
...
$db_select=mysql_select_db("bloodpools",$conn);
	...
	$extract=mysql_query("select * from registration where Username='$Username' and Password='$Password' ");
